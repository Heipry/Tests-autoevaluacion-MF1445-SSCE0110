export default [
  ...
  {
    question:
      "¿Cuál de los siguientes es un aspecto a tener en cuenta durante la redacción de una prueba de evaluación?:",
    options: [
      "Evitar el uso de trucos o trampas que puedan despistar a la persona que conoce la respuesta.",
      "Centrarnos en los objetivos y criterios evaluativos y no recurrir a trivialidades.",
      "Identificar las deficiencias en la prueba e introducir las mejoras que se consideren oportunas para futuras ediciones.",
      "Analizar la dificultad de cada elemento y la dificultad de la prueba en su conjunto.",
    ],
    correctAnswer:
      "Evitar el uso de trucos o trampas que puedan despistar a la persona que conoce la respuesta.",
    justification:
  ...
  {
    question:
      "Según Bloom para alcanzar un objetivo a nivel cognoscitivo es necesario pasar por seis fases, organizadas en una pirámide en la que se representan las aptitudes y capacidades intelectuales. ¿cuál es el primer escalón?:",
  ...
  },
  {
    ...
    options: [
      "En este tipo de pruebas hay que contestar a un enunciado propuesto con una respuesta verdadero/ falso, o sí/no.",
      "La respuesta a este tipo de ítems consiste en asociar parejas de elementos de dos conjuntos de información.",
      "Son preguntas que exigen al alumnado redactar respuestas concretas.",
      "En este tipo de pruebas se trata de elegir la respuesta adecuada entre varias alternativas que se presentan al alumnado.",
    ],
    correctAnswer:
      "Son preguntas que exigen al alumnado redactar respuestas concretas.",
    justification:
  ...
  {
    question:
      "¿Cuál de los siguientes es un factor que determine el éxito o fracaso en la aplicación de una prueba objetiva?:",
    options: [
      "Los conocimientos que tenga el formador/a sobre la materia.",
      "Las normas que haya establecido el centro de formación.",
      "La buena disposición del alumno/a ante la prueba.",
      "La preparación de la persona que evalúa.",
    ],
  ...
  {
    question:
      "Al presentar la prueba objetiva al alumnado, ¿Cuál de las siguientes es una instrucción de aplicación relacionada con la prueba?:",
    options: [
      "Indicar la forma de registrar la respuesta o si pueden hacerlo de la manera que les resulte más cómoda.",
      "Indicar si pueden entregarlo cuando terminen y marcharse.",
      "Indicar el material de la prueba y lo que contiene (manual, hoja de respuestas, etc.).",
      "Indicar la calificación mínima para superar la prueba.",
    ],
    correctAnswer:
      "Indicar el material de la prueba y lo que contiene (manual, hoja de respuestas, etc.).",
    justification:
  ...
  {
    question:
      "¿Con qué tipo de pruebas podemos evaluar los aprendizajes más complejos, que vienen representados por los escalones de análisis, síntesis y evaluación de la pirámide de Bloom?:",
    options: [
  ...
  {
    question:
      "De los elementos de una prueba objetiva repartida a lo largo de un manual, ¿a qué nos referimos cuando hablamos del protocolo o reactivos como parte de su estructura?:",
    options: [
      "Al lugar en el que se registran las respuestas.",
      "Al lugar en el que se escribe la respuesta correcta para cada ítem.",
      "A las instrucciones de la prueba.",
      "A los ítems.",
    ],
