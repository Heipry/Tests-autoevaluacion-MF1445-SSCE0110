<p align="center">
  <a href="https://heipry.github.io/Tests-autoevaluacion-MF1445-SSCE0110/evaluacion.html" target="_blank">
...
Las preguntas se han elaborado específicamente para el **Módulo Formativo MF1445_3: Evaluación del proceso de enseñanza-aprendizaje en Formación Profesional para el Empleo"**, sirviendo como herramienta de apoyo pedagógico.
...
Los tests están organizados en distintos archivos JavaScript, cada uno correspondiente a un bloque o tema del módulo formativo.  
...
git clone https://github.com/Heipry/Tests-autoevaluacion-MF1445-SSCE0110.git

# Navega al directorio
cd Tests-autoevaluacion-MF1445-SSCE0110
...
👉 [Abrir la aplicación en GitHub Pages](https://heipry.github.io/Tests-autoevaluacion-MF1445-SSCE0110/evaluacion.html)
